Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/03bb07500b5e03544a65f8011fde1039"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength1 = (0.1 /*_EmissionStrength1*/);
				...
				{
					emissionStrength1 *= calculateBlinkingEmission((0.0 /*_EmissiveBlink_Min1*/), (1.0 /*_EmissiveBlink_Max1*/), (3.0 /*_EmissiveBlink_Velocity1*/), (0.5 /*_EmissionBlinkingOffset1*/));
				}
				if ((1.0 /*_EmissionHueShiftEnabled1*/))
				{
					...
					emissionColor1 = lerp(emissionColor1, dot(emissionColor1, float3(0.3, 0.59, 0.11)), - ((1.48 /*_EmissionSaturation1*/)));
				}
				#if defined(PROP_EMISSIONMASK1) || !defined(OPTIMIZER_ENABLED)
